...
<ol>
  <li>Logistic Regression on Fashion MNIST Data</li>
  <li>Feed Forward Network on Fashion MNIST Data</li>
  <li>Convolutional Neural Network on Fashion MNIST Data</li>
  <li>Logistic Regression on RBM Hidden Features (of Fashion MNIST Data)</li>
  <li>Feed Forward Network on RBM Hidden Features (of Fashion MNIST Data)</li>
</ol>
...
Best Optuna Trial: overjoyed-moose-462, accuracy 84.71%<br>
![](lr_norbm_params.png){width="60%"} <br>
...
Best Optuna Trial: smiling-ape-201, accuracy 88.06%<br>
![](fnn_norbm_params.png){width="60%"} <br>
...
Best Optuna Trial: popular-moose-855, accuracy 91.29%<br>
![](cnn_params.png){width="60%"} <br>
...
Best Optuna Trial: caring-hare-904, accuracy 87.14%<br>
![](lr_wrbm_params.png){width="60%"} <br>
...
#![](Picture1.png){width="60%"}

```

</details>

Best Optuna Trial: valuable-chimp-596, accuracy 86.98%<br>
![](fnn_wrbm_params.png){width="60%"} <br>
...
| Features)            |                      |                   |
+----------------------+----------------------+-------------------+
| Feed Forward Network | 86.98                | 0.868             |
| (on RBM Hidden       |                      |                   |
| Features)            |                      |                   |
+----------------------+----------------------+-------------------+
<p>(Table 2)</p>
